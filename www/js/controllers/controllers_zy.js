...
// 上传资质证书-zxf
.controller('uploadcertificateCtrl', ['$interval', 'CONFIG', 'Dict', 'Doctor', '$scope', '$state', '$ionicHistory', '$timeout', 'Storage', '$ionicPopup', '$ionicLoading', '$ionicPopover', '$ionicScrollDelegate', 'User', '$http', 'Camera', '$ionicModal', '$stateParams', 'socket', 'mySocket', 'Mywechat', '$location', function ($interval, CONFIG, Dict, Doctor, $scope, $state, $ionicHistory, $timeout, Storage, $ionicPopup, $ionicLoading, $ionicPopover, $ionicScrollDelegate, User, $http, Camera, $ionicModal, $stateParams, socket, mySocket, Mywechat, $location) {
  $scope.doctor = {}
...
// "我”页-zy,mzb,zxf
.controller('meCtrl', ['$ionicActionSheet', 'CONFIG', 'Camera', 'Doctor', '$scope', '$state', '$interval', '$rootScope', 'Storage', '$ionicPopover', '$http', '$ionicPopup', 'User', 'Mywechat', '$location', '$timeout', '$ionicLoading', function ($ionicActionSheet, CONFIG, Camera, Doctor, $scope, $state, $interval, $rootScope, Storage, $ionicPopover, $http, $ionicPopup, User, Mywechat, $location, $timeout, $ionicLoading) {
  $scope.barwidth = 'width:0%'
    // $scope.$on('$ionicView.beforeEnter', function() {
    //     $scope.doRefresh();
    // });
...
// 我的个人资料页-zy，zxf
.controller('myinfoCtrl', ['CONFIG', 'Dict', 'Camera', 'Doctor', '$scope', 'Storage', '$ionicPopover', '$ionicModal', '$ionicScrollDelegate', 'Mywechat', '$location', '$ionicPopup', '$ionicLoading', '$timeout', function (CONFIG, Dict, Camera, Doctor, $scope, Storage, $ionicPopover, $ionicModal, $ionicScrollDelegate, Mywechat, $location, $ionicPopup, $ionicLoading, $timeout) {
  $scope.hideTabs = true
...
.controller('postCtrl', ['$scope', '$state', 'Storage', '$ionicHistory', '$ionicPopover', 'Forum', 'Camera', 'CONFIG', '$ionicLoading', '$timeout', '$ionicModal', '$ionicScrollDelegate', 'Mywechat', '$location', '$ionicPopup', function ($scope, $state, Storage, $ionicHistory, $ionicPopover, Forum, Camera, CONFIG, $ionicLoading, $timeout, $ionicModal, $ionicScrollDelegate, Mywechat, $location, $ionicPopup) {
  $scope.GoBack = function () {
