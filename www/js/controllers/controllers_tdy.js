...
//健康详情-zy,zxf,pxy
.controller('HealthDetailCtrl', ['CONFIG','ionicDatePicker','$scope','$state','$ionicHistory','$ionicPopup','$stateParams','$ionicPopover','$ionicModal','$ionicScrollDelegate','$ionicLoading','$timeout','Dict','Health','Storage','Camera','Mywechat','$location',function(CONFIG,ionicDatePicker,$scope, $state,$ionicHistory,$ionicPopup,$stateParams,$ionicPopover,$ionicModal,$ionicScrollDelegate,$ionicLoading,$timeout,Dict,Health,Storage,Camera,Mywechat,$location) {
  $scope.barwidth="width:0%";
  var patientId = Storage.get('getpatientId')
  // console.log(patientId)
  // $scope.test = function(){
